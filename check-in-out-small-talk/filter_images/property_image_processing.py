...
DB_USER = 'within_dev' # 'yeogi' #os.environ['DB_USER']
DB_PASSWORD = 'With!n@()' # 'DQlapaTm&79()' #os.environ['DB_PASSWORD']
...
if __name__ == '__main__':
    ...
    try:
        ...
        for property_seq in event['property_seq']:
            ...
            if not images:
                print(f"{'message': f'No images found for property_seq: {property_seq}'}")
